...
Automatic game state persistence to MongoDB after every player action via a handler decorator and a game state repository. Persistence is invisible to the player — no save command exists.
