...
The game SHALL display the starting room's name, description, and exits when the game begins.

#### Scenario: Game startup

- **WHEN** the game starts with starting room "Cave Entrance"
- **THEN** the output SHALL contain the room name, description, and available exits
