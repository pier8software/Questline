# content-deploy-container Specification

## Purpose

Define the containerised content deployer that builds the Questline application into a Docker image and runs it as an Aspire-managed resource to seed adventure content into MongoDB.
