...
### Requirement: Game mode seeds content before starting

**Reason**: Content seeding is now the sole responsibility of `deploy-content` mode. Game mode assumes content has already been deployed to the database.

**Migration**: Run the application in `deploy-content` mode before starting game mode to ensure adventure content is available.
