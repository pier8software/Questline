...
public class GameBuilder
{
    ...
    private string         _characterName  = "TestHero";
    private Race           _race           = Race.Human;
    private CharacterClass _class          = CharacterClass.Fighter;
    private AbilityScores  _abilityScores  = DefaultAbilityScores;
    private HitPoints      _hitPoints      = DefaultHitPoints;
...
public class FakeRoomRepository : IRoomRepository
{
    ...
    public FakeRoomRepository(Dictionary<string, Room> rooms)
    {
        _rooms = rooms;
    }
    ...
    public Task<string> GetStartingRoomId(string adventureId) =>
        Task.FromResult(_rooms.Keys.First());
}
